            ...
            <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                ...
                <div className="bg-white shadow-lg rounded-lg overflow-hidden">
                    <div className="px-6 py-4 border-b border-gray-200">
                        ...
                        <p className="text-sm text-gray-600 mt-1">Define a new performance milestone with bonus reward</p>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="p-6 space-y-6">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                placeholder="e.g., 60 Day Streak Champion"
                            />
                        ...
                        <div>
                            ...
                            <textarea
                                ...
                                className="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500"
                                placeholder="Describe what employees need to achieve..."
                            />
                        ...
                        <div>
                            ...
                            <input
                                ...
                                className="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500"
                                placeholder="e.g., 60 for 60 days"
                                min="1"
                            />
                            <p className="mt-1 text-xs text-gray-500">
                                {data.type === 'streak' && 'Number of consecutive working days'}
                                {data.type === 'total_days' && 'Total number of days worked'}
                                {data.type === 'attendance_rate' && 'Percentage (0-100)'}
                                {data.type === 'on_time_rate' && 'Percentage (0-100)'}
                            </p>
                        ...
                        <div>
                            ...
                            <input
                                ...
                                maxLength="10"
                            />
                            <p className="mt-1 text-xs text-gray-500">Choose an emoji to represent this milestone</p>
